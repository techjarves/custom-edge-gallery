...
import com.server.edge.gallery.common.processLlmResponse
import com.server.edge.gallery.data.Model
import com.server.edge.gallery.data.Task
import com.server.edge.gallery.runtime.runtimeHelper
    ...
    viewModelScope.launch(Dispatchers.Default) {
      ...
      val supportImage =
        model.llmSupportImage &&
          task.id == com.server.edge.gallery.data.BuiltInTaskId.LLM_ASK_IMAGE
      val supportAudio =
        model.llmSupportAudio &&
          task.id == com.server.edge.gallery.data.BuiltInTaskId.LLM_ASK_AUDIO
