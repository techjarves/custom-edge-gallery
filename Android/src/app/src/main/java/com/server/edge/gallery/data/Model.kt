...
data class Model(
   ...
   * - `com.server.edge.gallery` for builds from the GitHub source.
   * - `com.server.edge.gallery` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.server.edge.gallery/files/my_model/local_dir/
   *
