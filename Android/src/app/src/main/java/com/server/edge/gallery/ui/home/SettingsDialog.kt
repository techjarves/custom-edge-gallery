        ...
        Column(
          ...
          Column(
            ...
            var cfToken by remember {
              mutableStateOf(
                com.server.edge.gallery.openai.OpenAiServerState.cloudflareTunnelToken(context)
              )
            }
            var cfUrl by remember {
              mutableStateOf(
                com.server.edge.gallery.openai.OpenAiServerState.cloudflarePublicUrl(context)
              )
            }
            var ngrokToken by remember {
              mutableStateOf(
                com.server.edge.gallery.openai.OpenAiServerState.ngrokAuthToken(context)
              )
            }
            var ngrokDomain by remember {
              mutableStateOf(
                com.server.edge.gallery.openai.OpenAiServerState.ngrokDomain(context)
              )
            }
            ...
            OutlinedButton(
              onClick = {
                com.server.edge.gallery.openai.OpenAiServerState.persistCloudflareTunnelConfig(
                  context, cfToken, cfUrl
                )
                com.server.edge.gallery.openai.OpenAiServerState.persistNgrokConfig(
